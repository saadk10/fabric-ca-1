...
The following link shows the :doc:`Server Command Line <servercli>`
The following link shows the :doc:`Client Command Line <clientcli>`
...
(see `Fabric CA Server <#server>`__ section more info). To see a sample
configuration file, click :doc:`here <server_config>`
...
(see `Fabric CA Client <#client>`__ section more info). To see a sample
configuration file, click :doc:`here <client_config>`
